...
public class ModFoods {
    public static final FoodProperties AMETHYST_APPLE = new FoodProperties.Builder().nutrition(4).
            saturationMod(1.2f).effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 0), 1.0F).effect(new MobEffectInstance(MobEffects.NIGHT_VISION, 2400, 0), 1.0F).alwaysEat().build();
    public static final FoodProperties AMETHYST_CARROT = new FoodProperties.Builder().nutrition(5).
            saturationMod(1.0f).alwaysEat().build();
}
